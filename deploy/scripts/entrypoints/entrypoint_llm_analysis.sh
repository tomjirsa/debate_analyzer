...
# Optional: LLM_MODEL_ID (default Qwen/Qwen2-1.5B-Instruct), MOCK_LLM=1 for tests.
# Optional (16 GB GPU): LLM_MAX_MODEL_LEN (default 8192), LLM_GPU_MEMORY_UTILIZATION (default 0.80).
