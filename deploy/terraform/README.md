...
| `batch_llm_compute_instance_types` | GPU instance types for LLM job (16 GB T4, e.g. g4dn.2xlarge; use LLM_MAX_MODEL_LEN=8192; for 32k use 24 GB+ instance) | `["g4dn.2xlarge"]` |
